...
public class RS extends ListActivity {
    protected void onCreate (Bundle icicle){
        ...
        String[] listRS = new String[]{"Rumah sakit Awal Bross","RS Eka Hospital","Rumah sakit Tampan","Rumah sakit Tabrani"};
    ...
    private void tampilkanpilihan(String pilihan) {
        try{
            ...
            if(pilihan.equals("Rumah sakit Awal Bross")){
                a = new Intent(this,RSAwal.class);

            }else if(pilihan.equals("RS Eka Hospital")){

            }else if(pilihan.equals("Rumah sakit Tampan")){
